...
var ContextServiceProvider = class extends ServiceProvider {
  /**
...
ContextServiceProvider = __decorateClass([
  injectable()
...
export { ConsoleHandler, ContextDehydratingEvent, ContextHydratedEvent, ContextLogProcessor, ContextManager, ContextRepository, ContextServiceProvider, DateFormat, ErrorLogHandler, EventDispatcher, ExceptionFormatter, FingersCrossedHandler, FormatterType, HandlerType, HttpHandler, IConsoleHandler, IContextDehydrating, IContextHydrated, IContextLogProcessor, IContextManagement, IContextManager, IErrorLogHandler, IEventDispatcher, IExceptionFormatter, IFingersCrossedHandler, IHttpHandler, IIndexedDBHandler, IJsonFormatter, ILineFormatter, ILocalStorageHandler, ILogEvent, ILogFormatter, ILogHandler, ILogManager, ILogProcessor, ILoggingChannel, ILoggingService, IMessageLogged, IMessagePlaceholderProcessor, ISimpleFormatter, ISingleChannel, ISlackWebhookHandler, IStackChannel, ISyslogHandler, IndexedDBHandler, JsonFormatter, LineFormatter, LocalStorageHandler, LogChannelType, LogLevel, LogLevelColor, LogLevelEmoji, LogLevelValue, LogManager, LogServiceProvider, Logger, MessageLoggedEvent, MessagePlaceholderProcessor, ProcessorType, SimpleFormatter, SingleChannel, SlackWebhookHandler, StackChannel, SyslogHandler, formatDate, getDateFormatString, isBoolean, isEmpty, isFunction, isNull, isNullOrUndefined, isNumber, isObject, isString, isUndefined, loggingConfig, merge };
